#############################################################################
# Makefile for building: softrx-client
...
softrx-client: ui_radio.h ui_settingsdialog.h $(OBJECTS)  
...
compiler_uic_make_all: ui_radio.h ui_settingsdialog.h
compiler_uic_clean:
	-$(DEL_FILE) ui_radio.h ui_settingsdialog.h
ui_radio.h: radio.ui \
		/usr/bin/uic
	/usr/bin/uic radio.ui -o ui_radio.h
